...
label day9scene:
    ...
    show timmy think
    timmy "Ох, привет Day[9]... Не очень хорошо."
    show day hmm
    ...
    timmy "Вау, правда...? Спасибо Day[9], ты лучший!"
    show day happy
    ...
    timmy "Пожалуйста, Day[9], я не настолько плох. Какой человек скачивает визуальные новеллы о StarCraft не зная что это популярная стратегия в реальном времени, созданная Blizzard?"
    show day neutral
    ...
    show timmy neutral
    timmy "Да я думаю, что всё усвоил Day[9]. Теперь я могу читать SC2VN не гугля каждые пять минут! Спасибо, что помогли мне. Я очень сильно ценю это."
